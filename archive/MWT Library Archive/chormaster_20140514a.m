...
switch chorstatus
    case 'old'
        [pMWTp,pMWTc] = checkchorhistory(pMWT,chorfile);
    case 'new'
        pMWTc = pMWT;
end
...
%% RUN CHOR
if isempty(pMWTc) == 0
    runchor(pMWTc,chorscript); % capable of running multiple chorscript
end


%% RE-CHECK CHOR OUTPUT
[pMWTpass,pMWTfail] = checkchorhistory(pMWT,chorfile);
