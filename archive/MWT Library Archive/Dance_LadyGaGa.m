function [varargout] = Dance_LadyGaGa(varargin)
...
% processing inputs
if tinput ==0; 
    ti = MWTfsprevStartTime; 
elseif isempty(tinput)==1; 
    ti = MWTfsprevStartTime; 
    tinput = 0; 
elseif tinput>MWTfsprevStartTime; 
    ti = tinput; 
else
    ti = 0;
end
...
if isempty(durinput)==0 && isnan(durinput) ==0; 
    duration = 'restricted'; 
else
    duration = 'all';
end
