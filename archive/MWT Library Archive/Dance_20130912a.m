...
%% STEP3B: STAND EXPERIMENT FOLDER NAME
%% STEP3C: GROUP MWT FILES
%% STEP3D: CHECK MWT RUN NAMES


%% STEP4: DEFINE EXP OBJECTIVES
...
%% STEP4C: DEFINE ANALYSIS OBJECTIVES
