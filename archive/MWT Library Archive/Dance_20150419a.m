...
MWTSet.PATHS.pSave = [pDriveHome,'MWT_AnalysisOutput'];
MWTSet.timestamp = generatetimestamp;
MWTSet.PATHS.pSaveA = [MWTSet.PATHS.pSave,'/',generatetimestamp];
...
while confirm == 0
    ...
    i = input(': ','s')';
    GroupSeq = [num2cell((1:numel(GroupNameU))'), GroupNameU(str2num(i))];
    display ' ';
