...
pList.pFun = '/Users/connylin/OneDrive/MATLAB/Functions_Developer';
addpath(pList.pFun);
pList.pJava = pList.pFun;
pList.pData = '/Volumes/ParahippocampalGyrus/MWT_Data';
pList.pSave = '/Users/connylin/OneDrive/Dance Output';
pList.pFunA = '/Users/connylin/OneDrive/MATLAB/Projects_RankinLab/MWT_Dance/Dance_AnalysisPack';
pList.pFunG = '/Users/connylin/OneDrive/MATLAB/Projects_RankinLab/MWT_Dance/Dance_GraphPack';
...
% [A] = GetStdMWTDataBase(pList.pData);
% [A] = MWTDatabase_search(pList.pData);


% unzip files
% a = cellfun(@fileparts,cellfun(@fileparts,...
%     A.pZipf,'UniformOutput',0),'UniformOutput',0);
% [f,n] = cellfun(@fileparts,unique(a),'UniformOutput',0);
