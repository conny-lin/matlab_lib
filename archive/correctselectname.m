function [MWTfsncorr] = correctselectname(MWTfgcode,MWTfsn,mwtnogcode)
q = 1;
disp(MWTfgcode);
...
MWTfnameC = cellfun(@strcat,mwtnogcode,MWTfgcode(:,2),'UniformOutput',0); % reconstruct
MWTfsncorr = cat(2,MWTfsn(:,1),MWTfnameC);
