...
function [DesStats,N,Mean,SE,DesStatsh] = decriptstats_LadyGaGa(sumimport,Summaryheader,SumName,pExp)
% Summaryheader
...
%% get mean per stim [suspended because .sprevs are not saved now]
% import data
