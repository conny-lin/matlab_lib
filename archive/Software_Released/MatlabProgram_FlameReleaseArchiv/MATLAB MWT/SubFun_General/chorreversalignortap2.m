function chorreversalignortap2(pMWT)
...
%% java arguments ---------------------------------------------------------
% call java
javacall = 'java -jar'; javaRAM = '-Xmx8G';
% call beethoven 
...
pluginreversal_notap = '--plugin MeasureReversal::postfix=sprevs';
pluginreversalT = '--plugin MeasureReversal::tap::collect=0.5::postfix=ssr';
...
var = {javacall,javaRAM,chor,pixelsize,speed,mintime,minmove,...
            shape,output2,pluginreoutline,pluginrespine,...
            pluginreversal_notap,pluginreversalT,file}'; 
i = size(var,1);
s = {'%s '};
s2(1:i) = s;
s3 = cell2mat(s2);
