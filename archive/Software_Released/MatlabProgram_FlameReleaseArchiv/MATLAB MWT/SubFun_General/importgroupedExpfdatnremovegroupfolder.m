function [ExpfdatGR,MWTfGrecord,MWTf,pMWTf,I] = importgroupedExpfdatnremovegroupfolder(pExp)
...
for x = 1:size(pGroupf,1);
    ...
    A(1:size(f,1),1) = num2cell(x); % get group index
...
save(savename,'UngroupRecord','ExpfdatGR','MWTfGrecord');
