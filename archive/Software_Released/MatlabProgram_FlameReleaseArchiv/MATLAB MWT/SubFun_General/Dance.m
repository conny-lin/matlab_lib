...
if optioni ==0; timeintervalstatus = 'input'; end
...
%% STEP3A: USER INPUT-TIME INTERVALS
...
%% STEP4: CHOR 
%% STEP4C: CHOR OUTPUTS AND RUN CHOR
...
%% STEP5: ANALYSIS SWITCH BOARD
%% STEP5A: IMPORT CHOR OUTPUTS
