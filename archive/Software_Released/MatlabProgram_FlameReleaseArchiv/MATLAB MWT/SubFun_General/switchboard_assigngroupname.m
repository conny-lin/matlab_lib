function [GA,MWTfgcode] = switchboard_assigngroupname(MWTfsn,pFun,pExp,id)
%id = select group name method id
% no graphing sequence selection
q = 0;
while q ==0;
    %% decide on group assign method
    if id==0;
    ...
    switch q1;
        ...
        case 0 
            ...
            [~,~,~,MWTfgcode,RClist] = getMWTRC2(MWTfsn); 
...
b(1:size(GA,1),1) = {']'};
GAd = {};
GAd = cell2mat(cellfun(@strcat,a,GA(:,1),b,GA(:,2),'UniformOutput',0));
disp(GAd);
