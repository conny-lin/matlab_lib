...
%% Dance-flame specific
pFun = '/Volumes/FLAME/MatlabProgram/Functions_General';
addpath(genpath(pFun));
cd(pFun);
PathCommonList; 

addpath(genpath(paths.MWT.pFun));
pSet = paths.MWT.pSet;
addpath(genpath('/Volumes/FLAME/MatlabProgram/MATLAB MWT/SubFun_General'));
addpath(genpath('/Volumes/FLAME/MatlabProgram/MATLAB MWT/SubFun_General'));
