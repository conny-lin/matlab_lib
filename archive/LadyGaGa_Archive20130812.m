function LadyGaGa(pExp,pFun,choice,graph,Overwrite,zipfile,sprevsQ)
...
switch Overwrite
    case 0; % no chor had done before
        LadyGaGaChor_v1(pExp);
    case 1; % chor had been done before
...
switch sprevsQ
    ...
    case 0; % don't run new condition
        % do nothing
end
