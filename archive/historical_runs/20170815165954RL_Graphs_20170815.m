...
pSavefolder = setup_std(mfilename('fullpath'),'RL','genSave',true); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for si = 1:numel(pMWTStrains) % for each strain
    ...
    OcA = Ochestra_Alcohol3Factor_v1708(pMWTStrains{si},pSavefolder,'pData',pData,'strain',strain,'overwrite',false);
    return
end
