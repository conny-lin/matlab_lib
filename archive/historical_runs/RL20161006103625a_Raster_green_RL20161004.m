...
% get list of strains not made
p = '/Users/connylin/Dropbox/RL Pub PhD Dissertation/Chapters/4-EARS/3-Results/2-Genes EARS/x-ratser 10sISI by strains RasterNew green test/Raster_green_RL20161004';
[~,~,f] = dircontent(p);
strainlist = setxor(strainlist,f);
...
for si = 53:numel(strainlist) % cycle through strains
