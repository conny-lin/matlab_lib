    ...
    for ci = 2:numel(colnames)
        ...
        switch cn
            ...
            case 'rev_c_ph_m0m4'
                ...
                a = PHC.pValue(i);
            case 'rev_c_spw_w0w4'
                i = ismember(PHCbytap.factors_1,'N2*0') & ismember(PHCbytap.factors_2,['N2*400']) | ...
                    ismember(PHCbytap.factors_2,'N2*0') & ismember(PHCbytap.factors_1,['N2*400']);
                d = PHCbytap(i,:);
                j = d.pValue < 0.05;
                t = d.tap(j);
                if numel(t) == 30
            ...
            case 'rev_c_spw_w0m0'
                i = ismember(PHCbytap.factors_1,'N2*0') & ismember(PHCbytap.factors_2,[sn,'*0']) | ...
                    ismember(PHCbytap.factors_2,'N2*0') & ismember(PHCbytap.factors_1,[sn,'*0']);
                d = PHCbytap(i,:);
                j = d.pValue < 0.05;
                t = d.tap(j);
                if numel(t) == 30
            ...
            case 'rev_c_spw_w0m4'
                i = ismember(PHCbytap.factors_1,'N2*0') & ismember(PHCbytap.factors_2,[sn,'*400']) | ...
                    ismember(PHCbytap.factors_2,'N2*0') & ismember(PHCbytap.factors_1,[sn,'*400']);
                d = PHCbytap(i,:);
                j = d.pValue < 0.05;
                t = d.tap(j);
                if numel(t) == 30
            ...
            case 'rev_c_spw_w4w0'
                i = ismember(PHCbytap.factors_1,'N2*400') & ismember(PHCbytap.factors_2,[sn,'*0']) | ...
                    ismember(PHCbytap.factors_2,'N2*400') & ismember(PHCbytap.factors_1,[sn,'*0']);
                d = PHCbytap(i,:);
                j = d.pValue < 0.05;
                t = d.tap(j);
                if numel(t) == 30
            ...
            case 'rev_c_spw_w4m4'
                i = ismember(PHCbytap.factors_1,'N2*400') & ismember(PHCbytap.factors_2,[sn,'*400']) | ...
                    ismember(PHCbytap.factors_2,'N2*400') & ismember(PHCbytap.factors_1,[sn,'*400']);
                d = PHCbytap(i,:);
                j = d.pValue < 0.05;
                t = d.tap(j);
                if numel(t) == 30
