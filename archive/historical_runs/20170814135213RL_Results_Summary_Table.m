    ...
    for ci = 1:numel(colnames)
        ...
        switch cn
            case 'resp_c_N'
                ...
                n = sortN2first(G',N');
                % get number
                a = cellfun(@num2str,n,'UniformOutput',0)';
            ...
            case 'rev_c_ph_w0w4'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*0') & ismember(PHC.factors_2,'N2*400'));
            case 'rev_c_ph_w0m0'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*0') & ismember(PHC.factors_2,[sn,'*0']));
            case 'rev_c_ph_w0m4'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*0') & ismember(PHC.factors_2,[sn,'*400']));
            case 'rev_c_ph_w4m0'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*400') & ismember(PHC.factors_2,[sn,'*0']));
            case 'rev_c_ph_w4m4'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*400') & ismember(PHC.factors_2,[sn,'*400']));
            case 'rev_c_ph_m0m4'
                a = PHC.pValue(ismember(PHC.factors_1,'N2*0') & ismember(PHC.factors_2,[sn,'*400']));
            case 'rev_c_spw_w0w4'
                PHCbytap
        ...
        %% % pair wise tap  (START HERE 20170808) ????????????????????????? 
%         easier to use raw data and analyze posthoc directly
