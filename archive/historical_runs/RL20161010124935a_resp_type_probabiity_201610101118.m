...
baseline_max = repmat(baseline_max, 1, size(Response,2));
baseline_min = min(Baseline')'; 
baseline_min = repmat(baseline_min, 1, size(Response,2));

% no response
a = nan(size(Response));
a(Response > baseline_max) = 1; 
a(Response < baseline_min) = -1;
