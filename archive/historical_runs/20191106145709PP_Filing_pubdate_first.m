...
%     end
%     
    typeNames(i,1) = d; % enter 8 digit date in array
end
...
% date sectorcode type description
for i = 1:size(FileNameTable,1)
   FileNameTable.filename{i}
