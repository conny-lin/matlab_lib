...
for si = 1:numel(strainnames)
    ...
    for ci = 1:numel(colnames)
        ...
        elseif ismember(cn,'rev_c_spw_w0w4') 
            ...
            R = R(i+1:end,:);
            % get info
            a = regexpcellout(R,'(?<=tap)\d','match'); % get tap number
            % get first group
            ...
            switch anamec
                ...
                otherwise
                    ...
                    g1 = regexpcellout(c(:,1),'_','spilt');
                    g2 = regexpcellout(c(:,2),'_','split');
            end
            % separate p value
