...
%% objective;
%  1.2 life factors (answers to 97 questions surveyed in Fit Brains Lifestyle Assessment® application)
% load data
load('/Users/connylin/Dropbox/Publication/Report FB MITACS EQ and Lifestyle/Data/Data_A1_2.mat');

return

%% exclude/inclusion critiera
% scores = 0
score(score.score == 0,:)= [];
% age 20-80
demographic = demographic(demographic.age >=20 & demographic.age <=80,:);
