...
%     text(leftalign,2300,'% total','Rotation',90,'FontSize',fs,'HorizontalAlignment','center','VerticalAlignment','middle');
    % time names
    fs = 20;     leftalign = 80;     
    text(leftalign,700,tnamelist{1},'Rotation',90,'FontSize',fs,'HorizontalAlignment','center','VerticalAlignment','middle');
    text(leftalign,1500,tnamelist{2},'Rotation',90,'FontSize',fs,'HorizontalAlignment','center','VerticalAlignment','middle');
