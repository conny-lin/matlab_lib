...
RespTargetName = 'decelerate forward';
...
for ti = 1:numel(timelist) % cycle through time choices
    ...
    for si = 1:size(strainNames,1) % cycle through strains
        ...
        [A,N,NV,mwtidlist] = responseType_pct_plate(plateinfo,R,RespTargetName);
        ...
        % make figure
        figure1 = createfigure(time', Mean', SEM', gnlist, genotype,RespTargetName);
        % ------------------------------------------------
