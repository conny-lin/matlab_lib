...
% MWTDB = parseMWTinfo(cellfun(@fileparts,pMat,'UniformOutput',0));
% % -----------------------------------------------------
% =========================================================================

% 
% 
% %% summarize per 1s SPEED, CURVE 10-99s  ===========================================
% 
% % settings: +++++++
% startTime = 10; 
% endTime = 99;
...
% a = cell2mat(DataAll);
% Data = array2table(a,'VariableNames',[{'mwtid','time'}, legendv]);
% % -----------------------------


[Data,MWTDB] = sumDataGangnam(pMWT,[10 1 99],'VarName',{'speed','curve'});

% store to output ++++
Statout.MWTDB = MWTDB;
StatOut.Data.byplate = Data;
% ----------------------
% =========================================================================
...
%% calculate by stats
gnu = unique(Data.groupname);
G = struct;

for msri = 1:numel(legendv)
