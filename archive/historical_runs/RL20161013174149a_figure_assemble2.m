...
%     for ti = 1:numel(tnamelist)
    ...
    % figure ------------------------
    close all;
    figure1 = figure('Visible','on','Position',[0 0 6 6],'PaperPosition',[0 0 6 6]);
    imshow(IMMH)
    % y axis label
    fs = 10; leftalign = 80; 
    ...
    LeftBar = repmat(colorcode,nrow,30,3);
    MiddleBar = repmat(colorcode,nrow,35,3);
    RightBar = repmat(colorcode,nrow,25,3);
