...
responseT2 = 1;
% data path
pData = '/Users/connylin/Dropbox/RL Pub PhD Dissertation/Chapters/4-EARS/3-Results/2-Genes EARS/x-response type probability/resp_type_probabiity_201610101118/Data';
% get times 
timelist = flip(dircontent(pData));
% -------------------
