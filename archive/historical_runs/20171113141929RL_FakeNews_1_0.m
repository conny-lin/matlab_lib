...
VT = categorical(Data.VideoOrText1);
VTN = Data.VideoOrText;
Age = Data.Age;
Sex = categorical(Data.sex1);
BT = categorical(Data.BT1);
Voting = categorical(Data.Voting1);
Media = categorical(Data.Media1);
NewsVarify = Data.Verify;

%% ANALYZE
% IV vs plausible, cleaned
[n,m,s,g] = grpstats(Plausible,VT,{'numel','mean','sem','gname'});
[p,tbl,stats] = anova1(Plausible,VT);

writetable(tbl,fullfile(datapath,'plausible vs videotext anova.csv'))
