...
for si = 1:numel(strainlist)
    ...
    for sgi= 1:numel(straingrouplist)
        ...
        Data.expdate = Raw2.Data.expdate;
        % ----------------------------------
        ...
        if strcmp(strain,'MT14480')
            i = ismember(Data.expdate,'20150104');
            sum(i)
            return 
            Data(i,:) = [];
        end
