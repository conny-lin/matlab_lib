...
for si = 1:numel(strainlist)
    ...
    for sgi= 1:numel(straingrouplist)
        ...
        color_lower = [0 0.498039215803146 0];
        ...
        % write in text
        pSave = create_savefolder(fullfile(pM,sprintf('PCT below control %s max',linedata)));
        ...
        fprintf(fid, 'percent above 0mM 0mM mean+%s = %.3f\n\n',linedata,refnum1);
        ...
        fprintf(fid, '\n\npercent between 0mM 0mM mean+/-%s\n\n',linedata);
        ...
        fprintf(fid, '\n\npercent below 0mM 0mM mean-%s = %.3f\n\n',linedata, refnum2);
