...
%% prep data +++++++++++
userinfoleg = {'age','gender','education'};
zscoreleg = Zscore.Properties.VariableNames;
lsleg = regexprep(legend_LS_Q.q_abbr1,' ','_');

categories = [userinfoleg' ; zscoreleg'; lsleg];
...
% get scores
S = Zscore;
if istable(S); S = table2array(S); end
...
TARGETS = pairwisecomp_getpairs(categories);
