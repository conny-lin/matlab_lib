...
% errorbar
e1 = errorbar(Y,E,'LineStyle','none','Color','k','LineWidth',3,'Marker','none');
% ------------------------
...
% Create axes
axes2 = axes('Parent',figure1,'Position',[0.25 0.11 0.35 0.8]);
hold(axes2,'on');
xlim([0 30.5]);
ylabel('P (reversal)');
xlabel('Tap');
...
% Create axes
axes3 = axes('Parent',figure1,'Position',[0.68 0.11 0.35 0.8]);
hold(axes3,'on');
xlim([0 30.5])
