...
chorvar = {javacall,javaRAM,chor,pixelsize,speed,mintime,minmove,...
            shape,pluginreoutline,pluginrespine,pluginreversal_notap,pMWT}'; 
i = size(chorvar,1);
s = {'%s '};
s2(1:i) = s;
s3 = cell2mat(s2);
chorescript = sprintf(s3,javacall,javaRAM,chor,pixelsize,speed,mintime,minmove,...
            shape,pluginreoutline,pluginrespine,pluginreversal_notap,pMWT);
%% run java
